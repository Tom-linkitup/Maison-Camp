...
<body>
        ...
        <nav role="navigation">
            <div id="menuToggle">
                ...
                <ul id="menu">
                    ...
                    <a href="latestNews.html"><li>最新消息</li></a>
                    <a href="#"><li>會員登入</li></a>
                    <a href="room-booking.html"><li>帳型介紹</li></a>
                    <a href="#"><li>立即訂房</li></a>
                    <a href="#"><li>精選商城</li></a>
                    <a href="#"><li>活動預約</li></a>
                    <a href="#"><li>聯絡我們</li></a>
    ...
    <div class="row-offcanvas row-offcanvas-left">
      <div id="sidebar" class="sidebar-offcanvas">
          <div class="col-md-12">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li id="info-edit" class="click-me active"><a href="#"><i class="fa fa-user"></i>會員資料修改</a></li>
      ...
      <div id="main">
          <div class="col-md-12">
            <div id="info-show" class="row info-form">
                <form method="POST" action="">
                    <fieldset>
                        <legend><i class="fas fa-user-circle"></i> 修改基本資料</legend>
                    ...
                    <fieldset>
                        ...
                        <div class="creditcard" style="display: none;">
                            ...
                            <div class="creditcard-logo">
                                <img style="width: 70px; height: 70px;" src="./img/Affinity-Partnership_VISA_600x600 LOGO-01.png" alt="" />
                            </div>
                        </div>
