...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/back-end/css/admin.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/back-end/css/context.css">
                ...
                <section class="sidebar">
                  <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<%=request.getContextPath() %>/back-end/emp/images/456.png" class="img-circle" alt="User Image">
                        </div>
                 ...
                 <ul class="sidebar-menu" data-widget="tree">
                      ...
                      <ul class="treeview-menu">
                          ...
                          <li><a href="<%=request.getContextPath()%>/back-end/room_extra_charges/select_page.jsp">額外消費管理</a></li>
                          <li><a href="#">入住管理</a></li>
                          <li><a href="#">退房管理</a></li>
                      </ul>
                      </li>
