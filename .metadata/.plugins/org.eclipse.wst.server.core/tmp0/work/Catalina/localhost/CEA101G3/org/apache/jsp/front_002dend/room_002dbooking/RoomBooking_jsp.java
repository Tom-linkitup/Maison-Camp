 ...
 * Generated at: 2021-01-03 04:09:34 UTC
...
public final class RoomBooking_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	pageContext.setAttribute("rsvList", rsvList);
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"4\">4間</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"5\">5間</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"6\">6間</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"7\">7間</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("                    img.setAttribute(\"style\", \"display:none; width:60%; margin-left:30px;\")\n");
      ...
      out.write("    \t\t\t\t\t} else if(data.isMam == \"true\"){\n");
      out.write("    \t\t\t\t\t\tcurrentDate.addClass(\"calendar-isMam\");\n");
      out.write("    \t\t\t\t\t} else {\n");
      out.write("    \t\t\t\t\t\t\n");
      ...
      out.write("        \t$(\".calendar-qty\").text(\"\");\n");
      out.write("        \t $(\".calendar-default\").removeClass(\"calendar-isFull calendar-isMam calendar-isEmpty\");\n");
      out.write("        })\n");
      out.write("        \n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /front-end/room-booking/RoomBooking.jsp(365,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("roomtypevo");
      // /front-end/room-booking/RoomBooking.jsp(365,10) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
