...
<!DOCTYPE html>
<%
  ItemVO itemVO = (ItemVO) request.getAttribute("itemVO"); //ItemServlet.java(Concroller), 存入req的empVO物件
%>
...
<table id="table-1">
	<tr><td>
		 <h3>員工資料 - ListOneItem.jsp</h3>
		 <h4><a href="<%=request.getContextPath()%>/back-end/item/select_page.jsp"><img src="images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
