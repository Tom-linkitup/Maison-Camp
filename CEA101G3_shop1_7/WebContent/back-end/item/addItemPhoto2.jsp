...
<c:if test="${not empty errorMsgs}">
	...
	<div id="content-2">
		<form method="post" class="photo-form" action="<%=request.getContextPath() %>/item_photo/itemPhoto.do" enctype="multipart/form-data" >
		...
		<div class="" style="margin-top:-30px; padding-bottom:7px;">
			...
			<input type="file" name="itemPhoto" multiple required>
			<p>拖曳照片或直接點擊區塊</p>
