...
<body>
	<div id="content-3">
		...
		<table id="myTable" border="1px solid #000">
			...
			<tr>
			    ...
			    <button class="edit1 btn btn-info" type="submit">修改</button>
				</td>
		...
		<div id="lightBox1" style="display:none;">
			<form method="post" action="${pageContext.request.contextPath}/repair/repair.do" enctype="multipart/form-data" >
				<table align="center" id="tableLogin">
					...
					<tr><td>房間代號：</td><td><input style="background-color:#f9f9f9; border:none;" id="room_id1" class="input-beautify" type="text" name="room_id" readonly ></td></tr>
					<tr><td>員工編號：</td><td><input style="background-color:#f9f9f9; border:none;" id="emp_id1" class="input-beautify" type="text" name="emp_id" readonly></td></tr>
					<tr><td>維修內容：</td><td><input id="repair_info1" class="input-beautify" type="text" name="repair_info" required></td></tr>
					<tr><td>維修狀態：</td>
					<td>
	...
	<script>		
		$(".edit1").click(function() {
			$("#lightBox1").css("display","");
			let tr = $(this).parents("tr");
			let children = tr.children();
			$("#repair_id1").val(children.eq(0).text());
			$("#room_id1").val(children.eq(1).text());
			$("#emp_id1").val(children.eq(2).text());
			$("#repair_info1").val(children.eq(3).text());
			$("#status").val(children.eq(4).text());
		})
		
		$("#btnEditCancel1").click(function() {
