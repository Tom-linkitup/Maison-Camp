...
<table id="table-1">
	<tr><td>
		 <h3>addItemPromotion.jsp</h3></td>
		 <td>
		 <h4><a href="<%=request.getContextPath()%>/back_end/item_promotion/select_page.jsp"><img src="<%=request.getContextPath()%>/back_end/item_promotion/images/189585.jpg" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<FORM METHOD="post" ACTION="<%=request.getContextPath() %>/item_promotion/item_promotion.do" name="form1">
	<table>
	   <tr>
	   <td>商品編號:</td>
	   <td><input type="TEXT" name="item_id" size="45" 
	   value="<%= (itemPromotionVO == null) ? "I10001": itemPromotionVO.getItem_id()%>"></td>
	   </tr>
	   
	   <tr>
	   <td>商品促銷資訊:</td>
	   <td><input type="TEXT" name="item_promotion_info" size="45" 
	   value="<%= (itemPromotionVO == null) ? "打折拉 哪是次不打": itemPromotionVO.getItem_promotion_info()%>"></td>
	   </tr>
	   
	   <tr>
	   <td>訂單總金額:</td>
	   <td><input type="TEXT" name="item_discount" size="45" 
	   value="<%= (itemPromotionVO == null) ? "0.8": itemPromotionVO.getItem_discount()%>"></td>
	   </tr>
	   
	   <tr>
	   <td>促銷開始時間:</td>
	   <td><input name="item_prom_start_date" id="f_date1" type="text" ></td>
	   </tr>
	   
	   <tr>
	   <td>促銷結束時間:</td>
	   <td><input name="item_prom_close_date" id="f_date2" type="text" ></td>
	   </tr>
