...
%>
<%
  ItemCommentVO itemCommentVO = (ItemCommentVO) request.getAttribute("itemCommentVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<title>員工資料修改 - update_item_comment_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>商品資料修改 - update_item_comment_input.jsp</h3>
...
<table>
	<tr>
		<td>商品評論編號:<font color=red><b>*</b></font></td>
