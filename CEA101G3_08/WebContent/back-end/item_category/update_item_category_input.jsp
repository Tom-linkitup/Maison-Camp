...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath() %>/back-end/iem_category/select_page.jsp"><img src="<%=request.getContextPath() %>/images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
