...
<html>
<head>
<title>所有商品資料 - listAllItemCategory.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有商品資料 - listAllItemCategory.jsp</h3>
		 <h4><a href="<%=request.getContextPath() %>/back-end/item_category/select_page.jsp"><img src="<%=request.getContextPath() %>/images/2.jpg" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<c:forEach var="itemCategoryVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/item_category/itemCategory.do" style="margin-bottom: 0px;">
