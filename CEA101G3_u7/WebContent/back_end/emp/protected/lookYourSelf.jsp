...
<body class="hold-transition skin-blue sidebar-mini">
	<header class="main-header">
		<a
			href="<%=request.getContextPath()%>/back_end/emp/protected/backer.jsp"
			class="logo"> <span class="logo-mini"><b>M</b></span> <span
			class="logo-lg"><b>Maison </b> Camp</span>
		</a>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown user user-menu"><a href="#"
						...
						<ul class="dropdown-menu">
							<li class=""><a
								href="<%=request.getContextPath()%>/back_end/emp/protected/lookYourSelf.jsp"
								class="">個人資料</a></li>
							<li><a
